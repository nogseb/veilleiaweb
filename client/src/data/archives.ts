import { veilleS39 as veilleData } from "./veille-s39";
import { veilleS38 as s38Data } from "./veille-s38";
import { veilleS37 as s37Data } from "./veille-s37";
import { veilleS36 as s36Data } from "./veille-s36";
...
import { veilleS31 as s31Data } from "./veille-s31";
import { veilleData as s30Data } from "./veille-s30";
import { veilleData as s29Data } from "./veille-s29";
...
import { veilleData as s24Data } from "./veille-s24";
...
// Semaine 39 — édition actuelle (données complètes depuis veille-s39.ts)
const s39: ArchiveEdition = {
...
// Semaine 38
const s38: ArchiveEdition = {
  week: s38Data.week,
  year: s38Data.year,
  date: s38Data.publicationDate,
  signalMajeur: s38Data.signalMajeur.title,
  domainsCount: s38Data.domainsCount,
  sourcesCount: s38Data.sourcesCount,
  criticalCount: s38Data.criticalCount,
  importantCount: s38Data.importantCount,
  actionsCount: s38Data.actionsCount,
  emergingCount: s38Data.emergingCount,
  syntheseExecutive: s38Data.syntheseExecutive,
  statDominante: s38Data.statDominante,
  domaines: s38Data.domaines,
  actions: s38Data.actions,
  signauxEmergents: s38Data.signauxEmergents,
  tendancesPassees: s38Data.tendancesPassees,
  dashboardDetails: s38Data.dashboardDetails,
  bonus: s38Data.bonus,
};

// Semaine 37
const s37: ArchiveEdition = {
  week: s37Data.week,
  year: s37Data.year,
  date: s37Data.publicationDate,
  signalMajeur: s37Data.signalMajeur.title,
  domainsCount: s37Data.domainsCount,
  sourcesCount: s37Data.sourcesCount,
  criticalCount: s37Data.criticalCount,
  importantCount: s37Data.importantCount,
  actionsCount: s37Data.actionsCount,
  emergingCount: s37Data.emergingCount,
  syntheseExecutive: s37Data.syntheseExecutive,
  statDominante: s37Data.statDominante,
  domaines: s37Data.domaines,
  actions: s37Data.actions,
  signauxEmergents: s37Data.signauxEmergents,
  tendancesPassees: s37Data.tendancesPassees,
  dashboardDetails: s37Data.dashboardDetails,
  bonus: s37Data.bonus,
};
...
const s36: ArchiveEdition = {
  week: s36Data.week,
  year: s36Data.year,
  date: s36Data.publicationDate,
  signalMajeur: s36Data.signalMajeur.title,
  domainsCount: s36Data.domainsCount,
  sourcesCount: s36Data.sourcesCount,
  criticalCount: s36Data.criticalCount,
  importantCount: s36Data.importantCount,
  actionsCount: s36Data.actionsCount,
  emergingCount: s36Data.emergingCount,
  syntheseExecutive: s36Data.syntheseExecutive,
  statDominante: s36Data.statDominante,
  domaines: s36Data.domaines,
  actions: s36Data.actions,
  signauxEmergents: s36Data.signauxEmergents,
  tendancesPassees: s36Data.tendancesPassees,
  dashboardDetails: s36Data.dashboardDetails,
  bonus: s36Data.bonus,
};
...
// Semaine 34
const s34: ArchiveEdition = {
  week: s34Data.week,
  year: s34Data.year,
  date: s34Data.publicationDate,
  signalMajeur: s34Data.signalMajeur.title,
  domainsCount: s34Data.domainsCount,
  sourcesCount: s34Data.sourcesCount,
  criticalCount: s34Data.criticalCount,
  importantCount: s34Data.importantCount,
  actionsCount: s34Data.actionsCount,
  emergingCount: s34Data.emergingCount,
  syntheseExecutive: s34Data.syntheseExecutive,
  statDominante: s34Data.statDominante,
  domaines: s34Data.domaines,
  actions: s34Data.actions,
  signauxEmergents: s34Data.signauxEmergents,
  tendancesPassees: s34Data.tendancesPassees,
  dashboardDetails: s34Data.dashboardDetails,
};

// Semaine 33
const s33: ArchiveEdition = {
  week: s33Data.week,
  year: s33Data.year,
  date: s33Data.publicationDate,
  signalMajeur: s33Data.signalMajeur.title,
  domainsCount: s33Data.domainsCount,
  sourcesCount: s33Data.sourcesCount,
  criticalCount: s33Data.criticalCount,
  importantCount: s33Data.importantCount,
  actionsCount: s33Data.actionsCount,
  emergingCount: s33Data.emergingCount,
  syntheseExecutive: s33Data.syntheseExecutive,
  statDominante: s33Data.statDominante,
  domaines: s33Data.domaines,
  actions: s33Data.actions,
  signauxEmergents: s33Data.signauxEmergents,
  tendancesPassees: s33Data.tendancesPassees,
  dashboardDetails: s33Data.dashboardDetails,
};

// Semaine 32
const s32: ArchiveEdition = {
  week: s32Data.week,
  year: s32Data.year,
  date: s32Data.publicationDate,
  signalMajeur: s32Data.signalMajeur.title,
  domainsCount: s32Data.domainsCount,
  sourcesCount: s32Data.sourcesCount,
  criticalCount: s32Data.criticalCount,
  importantCount: s32Data.importantCount,
  actionsCount: s32Data.actionsCount,
  emergingCount: s32Data.emergingCount,
  syntheseExecutive: s32Data.syntheseExecutive,
  statDominante: s32Data.statDominante,
  domaines: s32Data.domaines,
  actions: s32Data.actions,
  signauxEmergents: s32Data.signauxEmergents,
  tendancesPassees: s32Data.tendancesPassees,
  dashboardDetails: s32Data.dashboardDetails,
};

// Semaine 31
const s31: ArchiveEdition = {
  week: s31Data.week,
  year: s31Data.year,
  date: s31Data.publicationDate,
  signalMajeur: s31Data.signalMajeur.title,
  domainsCount: s31Data.domainsCount,
  sourcesCount: s31Data.sourcesCount,
  criticalCount: s31Data.criticalCount,
  importantCount: s31Data.importantCount,
  actionsCount: s31Data.actionsCount,
  emergingCount: s31Data.emergingCount,
  syntheseExecutive: s31Data.syntheseExecutive,
  statDominante: s31Data.statDominante,
  domaines: s31Data.domaines,
  actions: s31Data.actions,
  signauxEmergents: s31Data.signauxEmergents,
  tendancesPassees: s31Data.tendancesPassees,
  dashboardDetails: s31Data.dashboardDetails,
};

// Semaine 30
const s30: ArchiveEdition = {
  week: s30Data.week,
  year: s30Data.year,
  date: s30Data.publicationDate,
  signalMajeur: s30Data.signalMajeur.title,
  domainsCount: s30Data.domainsCount,
  sourcesCount: s30Data.sourcesCount,
  criticalCount: s30Data.criticalCount,
  importantCount: s30Data.importantCount,
  actionsCount: s30Data.actionsCount,
  emergingCount: s30Data.emergingCount,
  syntheseExecutive: s30Data.syntheseExecutive,
  statDominante: s30Data.statDominante,
  domaines: s30Data.domaines,
  actions: s30Data.actions,
  signauxEmergents: s30Data.signauxEmergents,
  tendancesPassees: s30Data.tendancesPassees,
  dashboardDetails: s30Data.dashboardDetails,
};
...
const s29: ArchiveEdition = {
  week: s29Data.week,
  year: s29Data.year,
  date: s29Data.publicationDate,
  signalMajeur: s29Data.signalMajeur.title,
  domainsCount: s29Data.domainsCount,
  sourcesCount: s29Data.sourcesCount,
  criticalCount: s29Data.criticalCount,
  importantCount: s29Data.importantCount,
  actionsCount: s29Data.actionsCount,
  emergingCount: s29Data.emergingCount,
  syntheseExecutive: s29Data.syntheseExecutive,
  statDominante: s29Data.statDominante,
  domaines: s29Data.domaines,
  actions: s29Data.actions,
  signauxEmergents: s29Data.signauxEmergents,
  tendancesPassees: s29Data.tendancesPassees,
  dashboardDetails: s29Data.dashboardDetails,
};
...
// Semaine 27
const s27: ArchiveEdition = {
  week: s27Data.week,
  year: s27Data.year,
  date: s27Data.publicationDate,
  signalMajeur: s27Data.signalMajeur.title,
  domainsCount: s27Data.domainsCount,
  sourcesCount: s27Data.sourcesCount,
  criticalCount: s27Data.criticalCount,
  importantCount: s27Data.importantCount,
  actionsCount: s27Data.actionsCount,
  emergingCount: s27Data.emergingCount,
  syntheseExecutive: s27Data.syntheseExecutive,
  statDominante: s27Data.statDominante,
  domaines: s27Data.domaines,
  actions: s27Data.actions,
  signauxEmergents: s27Data.signauxEmergents,
  tendancesPassees: s27Data.tendancesPassees,
  dashboardDetails: s27Data.dashboardDetails,
};

// Semaine 26
const s26: ArchiveEdition = {
  week: s26Data.week,
  year: s26Data.year,
  date: s26Data.publicationDate,
  signalMajeur: s26Data.signalMajeur.title,
  domainsCount: s26Data.domainsCount,
  sourcesCount: s26Data.sourcesCount,
  criticalCount: s26Data.criticalCount,
  importantCount: s26Data.importantCount,
  actionsCount: s26Data.actionsCount,
  emergingCount: s26Data.emergingCount,
  syntheseExecutive: s26Data.syntheseExecutive,
  statDominante: s26Data.statDominante,
  domaines: s26Data.domaines,
  actions: s26Data.actions,
  signauxEmergents: s26Data.signauxEmergents,
  tendancesPassees: s26Data.tendancesPassees,
  dashboardDetails: s26Data.dashboardDetails,
};

// Semaine 25
const s25: ArchiveEdition = {
  week: s25Data.week,
  year: s25Data.year,
  date: s25Data.publicationDate,
  signalMajeur: s25Data.signalMajeur.title,
  domainsCount: s25Data.domainsCount,
  sourcesCount: s25Data.sourcesCount,
  criticalCount: s25Data.criticalCount,
  importantCount: s25Data.importantCount,
  actionsCount: s25Data.actionsCount,
  emergingCount: s25Data.emergingCount,
  syntheseExecutive: s25Data.syntheseExecutive,
  statDominante: s25Data.statDominante,
  domaines: s25Data.domaines,
  actions: s25Data.actions,
  signauxEmergents: s25Data.signauxEmergents,
  tendancesPassees: s25Data.tendancesPassees,
  dashboardDetails: s25Data.dashboardDetails,
};
...
const s24: ArchiveEdition = {
  week: s24Data.week,
  year: s24Data.year,
  date: s24Data.publicationDate,
  signalMajeur: s24Data.signalMajeur.title,
  domainsCount: s24Data.domainsCount,
  sourcesCount: s24Data.sourcesCount,
  criticalCount: s24Data.criticalCount,
  importantCount: s24Data.importantCount,
  actionsCount: s24Data.actionsCount,
  emergingCount: s24Data.emergingCount,
  syntheseExecutive: s24Data.syntheseExecutive,
  statDominante: s24Data.statDominante,
  domaines: s24Data.domaines,
  actions: s24Data.actions,
  signauxEmergents: s24Data.signauxEmergents,
  tendancesPassees: s24Data.tendancesPassees,
  dashboardDetails: s24Data.dashboardDetails,
};
...
// Semaine 22
const s22: ArchiveEdition = {
  week: s22Data.week,
  year: s22Data.year,
  date: s22Data.publicationDate,
  signalMajeur: s22Data.signalMajeur.title,
  domainsCount: s22Data.domainsCount,
  sourcesCount: s22Data.sourcesCount,
  criticalCount: s22Data.criticalCount,
  importantCount: s22Data.importantCount,
  actionsCount: s22Data.actionsCount,
  emergingCount: s22Data.emergingCount,
  syntheseExecutive: s22Data.syntheseExecutive,
  statDominante: s22Data.statDominante,
  domaines: s22Data.domaines,
  actions: s22Data.actions,
  signauxEmergents: s22Data.signauxEmergents,
  tendancesPassees: s22Data.tendancesPassees,
  dashboardDetails: s22Data.dashboardDetails,
};
...
export const archives: ArchiveEdition[] = [s39, s38, s37, s36, s35, s34, s33, s32, s31, s30, s29, s28, s27, s26, s25, s24, s23, s22, s21, s19, s18, s17, s16, s15, s14, s13, s12, s11, s10];
// Export de l'édition courante
export const currentEdition = s39;
